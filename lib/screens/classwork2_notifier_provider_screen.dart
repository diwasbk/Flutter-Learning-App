...
import 'package:flutter_learning_app/view_models/staff-view_model.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          final staff = StaffModel(
                            ...
                            gender:
                                selectedGender!, // ! to tell Dart it's non-null
                            department:
                                selectedDepartment!, // ! to tell Dart it's non-null
                          );
                          ref
                ...
                const SizedBox(height: 32),
                // Check State
                staffViewModel.isLoading
                    ? const Center(child: CircularProgressIndicator())
                    : ListView.builder(
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount: staffViewModel.lstStaffs.length,
                        itemBuilder: (context, index) {
                          final staff = staffViewModel.lstStaffs[index];
                          return Container(
